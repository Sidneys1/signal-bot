...
from .types import Response, GroupId, AccountNumber, AccountUUID, DataMessage
...
IndividualContext: TypeAlias = Tuple[Literal['individual'], AccountNumber | AccountUUID, Name]
...
MentionHookDef: TypeAlias = Tuple[Literal['account'], AccountNumber | AccountUUID, MessageCb]
